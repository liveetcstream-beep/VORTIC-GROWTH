      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-24">
          ...
          <nav className="hidden lg:flex items-center gap-8 text-sm font-bold text-slate-700">
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-1.5 text-slate-800 hover:text-indigo-600 transition-colors py-2 font-extrabold"
                aria-expanded={dropdownOpen}
              >
                <span>Specializations</span>
                <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${dropdownOpen ? "rotate-180 text-indigo-600" : "text-slate-400"}`} />
              </button>

              {dropdownOpen && (
                <div className="absolute top-full left-0 mt-2 w-72 bg-white rounded-2xl border border-slate-200 shadow-2xl p-3 space-y-1.5 z-50 animate-in fade-in duration-150">
                  <a
                    href="/dental-seo"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[11px] text-slate-500">Implants, Invisalign & High-LTV Patients</div>
                    </div>
                  </a>
                  ...
                  <a
                    href="/concreters-seo"
                    onClick={() => setDropdownOpen(false)}
                    className="flex items-start gap-3 p-3 rounded-xl hover:bg-indigo-50/80 transition-colors group"
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[11px] text-slate-500">Driveways, Slabs & Commercial Leads</div>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[11px] text-slate-500">High-Retainer Case Acquisition</div>
                    </div>
                  </a>
                  ...
                  <a
                    href="/#industries"
                    onClick={() => setDropdownOpen(false)}
                    className="flex items-start gap-3 p-3 rounded-xl hover:bg-amber-50/80 transition-colors group"
                  >
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <a
              href="/#audit-form"
              className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white text-xs font-extrabold shadow-md shadow-indigo-600/25 hover:shadow-lg hover:shadow-indigo-600/30 transition-all hover:translate-y-[-1px]"
            >
